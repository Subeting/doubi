...
smtp_port="25,26,465,587,123,1900,22,137,43111,27015,19"
pop3_port="109,110,995,20800,161,389,111,520,27005"
imap_port="143,218,220,993,6881,751,11211,1434,5353,17,27960"
...
Cat_PORT(){
	Ban_PORT_list=$(iptables -t filter -L OUTPUT -nvx --line-numbers|grep "DROP"|grep "udp"|awk '{print $13}')
}
Cat_KEY_WORDS(){
	Ban_KEY_WORDS_list=""
